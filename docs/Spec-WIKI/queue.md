...
**Итог по всем волнам:** 41 решение accepted (D-001…D-042, из них D-029 superseded-by D-041) + 1 отложено в backlog (Q-E-36). Все 40 вопросов из overview §9 закрыты.
