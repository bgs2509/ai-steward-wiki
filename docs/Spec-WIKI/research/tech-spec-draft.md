...
- [D-015](../decisions/D-015-system-prompt-inject.md) — Hybrid `wiki.md` + `inbox.md` + `classifier.md`; SDK system instructions для Stage-0, CLI `--append-system-prompt @file` для Stage-1, semver+sha256 в audit.
