...
#            is M-SCHEDULER-CONSUMER's concern (R-1 separation of concerns).
#   SCOPE: set_cron_user_context, create_cron_user_job, fire_cron_user_job,
#          CronUserContextNotInitialisedError. Module-level _ctx registry
#          installed once at startup so the APScheduler callback can stay
#          picklable (only int args).
...
#   LAST_CHANGE: v0.0.1 - aisw-02v: initial cron-user firing bridge (mirrors M-SCHEDULER-FIRING shape)
# END_CHANGE_SUMMARY
