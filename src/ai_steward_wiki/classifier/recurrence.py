...
#   parse_recurrence - ru NL → RecurrenceParseResult (rule-based daily/weekly; escalate otherwise)
# END_MODULE_MAP
#
# START_CHANGE_SUMMARY
#   LAST_CHANGE: v0.0.2 - aisw-oqq: parse_recurrence rule-based ru parser + escalate
#   PREVIOUS:    v0.0.1 - aisw-oqq: Recurrence model + to_cron (daily/weekly MVP)
# END_CHANGE_SUMMARY
...
# ruff: noqa: RUF001 (Cyrillic literals in the ru recurrence regexes are intentional)
