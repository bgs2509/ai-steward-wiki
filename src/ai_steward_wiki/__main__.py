...
#   LAST_CHANGE: v0.8.1 - aisw-8gw: log llm.provider.ready when Codex readiness
#                succeeds so operators get a positive fallback-enabled anchor.
#   PREVIOUS:    v0.8.0 - aisw-8gw: build one process-local provider policy,
...
#   PREVIOUS:    v0.7.0 - aisw-8gw: contract-only plan for one shared provider circuit.
#   PREVIOUS:    v0.6.2 - aisw-xi8 (Step-13 grace-refresh): retroactively
